...
const initialRows = [
  createData(1, 'Codar', 'Atividade', '2024-05-13', '2022-05-14', 'Concluída', 'Recurso 1'),
  createData(2, 'Correr', 'Atividade ', '2024-05-14', '2022-05-15', 'Em Andamento', 'Recurso 2'),
  createData(3, 'Jogar', 'Atividade ', '2024-05-16', '2022-05-17', 'Aguardando', 'Recurso 3'),
  createData(4, 'Pular', 'Atividade ', '2024-05-18', '2022-05-19', 'Aguardando', 'Recurso 4'),
  createData(5, 'Nadar', 'Atividade ', '2024-05-20', '2022-05-21', 'Aguardando', 'Recurso 5'),
  createData(6, 'Lutar', 'Atividade ', '2024-05-22', '2022-05-23', 'Aguardando', 'Recurso 6'),
];
...
const ListarTarefa = () => {
  ...
  const handleDeletar = (id) => {
    ...
    <Card>
        ...
        <CardActions>
            <Button size="small" variant="contained" onClick={handleOpen}>Criar Atividade</Button>
